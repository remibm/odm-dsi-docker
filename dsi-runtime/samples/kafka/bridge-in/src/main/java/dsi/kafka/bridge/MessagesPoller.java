...
public class MessagesPoller extends Thread {
	 ...
	 */
	public MessagesPoller(String kafkaHostname, long kafkaPort, String topic, String dsiUrl) {
			...
			while (isRunning) {
				...
				for (TopicPartition partition : records.partitions()) {
					...
					for (ConsumerRecord<String, String> record : partitionRecords) {
						...
						int responseCode = sendToDSI(dsiUrl, event);
						if (responseCode != 200) {
	 ...
	 */
	private static int sendToDSI(String url, String event) {
